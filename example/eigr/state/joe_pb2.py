...
_JOESTATE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='languages', full_name='eigr.state.JoeState.languages', index=0,
...
JoeState = _reflection.GeneratedProtocolMessageType('JoeState', (_message.Message,), {
  ...
  '__module__' : 'eigr.state.joe_pb2'
  # @@protoc_insertion_point(class_scope:eigr.state.JoeState)
  })
